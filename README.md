...
| `eidr_core.altidtool_io` | AltIDTool input-line format (variable 3/4/5-col compose, tolerant parse; contract in `specs/altidtool-format.md`) **+** `parse_edit_line` / `AltIdRemoval` (spec v1.1, 0.32.0): the edit-file superset with removal lines |
